        ...
        <div class="apartfrom-left">
            ...
            <div class="apartfrom-left-test">
                <form class="register-form-validate" action="<?php echo site_url('pc/register/doRegister')?>" method="post">
                    <table class="table">
                        <tr>
                            <td class="apartfrom-cellular">用户名：</td>
                            <td class="apartfrom-position-hao clearfix">
                                ...
                                <?php endif;?>
                                <input type="text" name="username" class="required" placeholder="请输入您的用户名" autocomplete="off"/>
                                <i class="iconfont">&#xe605;</i>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="apartfrom-position-hao">
                                <input type="text" name="parent_id" value="<?php echo $parent_id?>" <?php if (!empty($parent_id)) :?>readonly="readonly"<?php endif;?> placeholder="填写推荐人送300游币,若无请留空" autocomplete="off"/>
                            </td>
                        </tr>
                        <tr class="apartfrom-negotiate">
                            ...
                            <td class="apartfrom-fise">
                                ...
                                <p>我已阅读并接受<a target="_blank" href="<?php echo $this->config->main_base_url.'reg/protocal.html'?>">《贝竹一站通网站服务协议》</a></p>
                            </td>
                        </tr>
                        <tr>
                            <td class="apartfrom-cellular"></td>
